/**
 * Algeria wilayas (58) – bilingual (French/Arabic).
 * Codes follow common administrative numbering (01..58).
 */
const DZ_WILAYAS = [
  ...
  { code: "57", nameFr: "El Meghaier", nameAr: "المغير" },
  { code: "58", nameFr: "El Meniaa", nameAr: "المنيعة" }
];

module.exports = { DZ_WILAYAS };
